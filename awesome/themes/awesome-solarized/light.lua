...
-- {{{ Main
theme = {}
theme.path = os.getenv( "HOME" ) .. "/.config/awesome/themes/awesome-solarized/"
...
theme.wallpaper_cmd = { "xsetroot -solid '"..theme.colors.base3.."'" }
-- }}}
...
theme.fg_urgent  = theme.colors.base0

theme.bg_normal  = theme.colors.base3
theme.bg_focus   = theme.colors.base2
theme.bg_urgent  = theme.colors.base03
