...
Singleton {
  ...
  // Stopped is excluded too: it means "no track", not "paused". Chrome keeps
  // its MPRIS object registered after it forgets a paused tab's session, and
  // that empty player showed as a pause icon with no title.
